...
COMMON_RULES = (
    ...
    "2. 공백포함 2,000~2,500자.\n"
    "3. ## ** 등 마크다운 기호 금지.\n"
    "4. 소제목으로 단락 구분(일부는 '~까요?' 질문형 소제목으로 → FAQ 자동 생성).\n"
    "5. 한 문단은 1~2문장으로 짧게, 모든 문장은 마침표/물음표로 종결(모바일 가독성).\n"
    "6. 강조 꿀팁은 한 줄 '[팁] ...', 주의는 '[주의] ...' 형식(각 1~2개, 선택).\n"
    "7. 구체적 수치 3개 이상. AI 티 나는 상투적 표현 금지.\n"
    "8. summary는 글 핵심을 25자 이내 3개로.\n"
